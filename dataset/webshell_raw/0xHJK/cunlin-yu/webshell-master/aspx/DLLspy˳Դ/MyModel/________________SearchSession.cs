...
namespace MyModel
{
    ...
    {
        //Files f = new Files();
        //System.Web.Caching.Cache ca = new System.Web.Caching.Cache();
        //Thread t1 = null;
        ...
        //public SearchSession(System.Web.Caching.Cache ccc)
        //{
        //    ca = ccc;
        //    if (ccc["FileSearchThread"] == null)              //线程执行结果信息
        //    {
        //       // list.Add("<br>Threading Result:<br>");
        //        ccc.Insert("FileSearchThread", list);
        //    }
